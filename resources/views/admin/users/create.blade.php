            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border-t-4 border-aat-blue p-8">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <x-text-input id="phone_number" class="block w-full border-gray-300 focus:border-aat-blue focus:ring-aat-blue rounded-md shadow-sm" type="text" name="phone_number" :value="old('phone_number')" placeholder="Contoh: 081234567890" />
